...
ta.connect("/home/stack/fgao/atk_poc/atk_tests/demo3.creds")
...
class ModelLinearRegressionTest(unittest.TestCase):
    ...
    def testLinearRegression(self):
        ...
        print "create frame"
        frame_name = 'LinearRegressionSampleFrame'
        ...
        model_name = 'POCLinearRegressionModel'
        ...
        model.train(frame,'GXY',['Age','Sex','Height','Weight','BMI','DBP','SBP','HCT','MCV','RDW_SD',
        ...
        self.assertEqual(output.column_names,['GXY','Age','Sex','Height','Weight','BMI','DBP','SBP','HCT',
                                              ...
                                              'DCJC','MJJC','RUT','PGI_PGII','Ca2','P3','K2','Na','CI','predicted_value'])
